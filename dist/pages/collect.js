...
var Collect = function (_wepy$page) {
    ...
    function Collect() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Collect.__proto__ || Object.getPrototypeOf(Collect)).call.apply(_ref, [this].concat(args))), _this), _this.config = {
            ...
            busy: false,
            hasNot: false
        }, _this.$props = { "job-item": { "xmlns:v-bind": { "for": "collect", "item": "item", "index": "index", "key": "index", "value": "1" }, "v-bind:listItem.once": { "for": "collect", "item": "item", "index": "index", "key": "index", "value": "1" }, "type": { "for": "collect", "item": "item", "index": "index", "key": "index", "value": "1" } } }, _this.$events = {}, _this.components = {
