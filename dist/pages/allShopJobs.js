...
var AllShopJobs = function (_wepy$page) {
    ...
    function AllShopJobs() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AllShopJobs.__proto__ || Object.getPrototypeOf(AllShopJobs)).call.apply(_ref, [this].concat(args))), _this), _this.config = {
            ...
            list: [],
            type: 0
        }, _this.$props = { "job-item": { "xmlns:v-bind": { "for": "list", "item": "item", "index": "index", "key": "{{index}}", "value": "3" }, "v-bind:listItem.once": { "for": "list", "item": "item", "index": "index", "key": "{{index}}", "value": "3" }, "type": { "for": "list", "item": "item", "index": "index", "key": "{{index}}", "value": "3" } } }, _this.$events = {}, _this.components = {
